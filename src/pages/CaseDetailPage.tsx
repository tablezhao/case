  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-5xl">
        ...
        <CardHeader className="bg-gradient-to-r from-primary/10 to-primary/5">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <CardTitle className="text-3xl mb-2">{caseData.app_name}</CardTitle>
        ...
        <CardContent className="pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-2">
              ...
              <p className="text-lg font-semibold">{caseData.report_date}</p>
            </div>
            ...
            {caseData.app_developer && (
              <div className="space-y-2">
                ...
                <p className="text-lg">{caseData.app_developer}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xl font-bold">主要违规内容</h3>
            </div>
      ...
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">案例信息</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex justify-between py-2 border-b">
              ...
              <span>{new Date(caseData.updated_at).toLocaleDateString('zh-CN')}</span>
            </div>
            <div className="flex justify-between py-2 border-b">
