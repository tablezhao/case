CREATE OR REPLACE FUNCTION get_home_charts_core_data(time_range TEXT DEFAULT 'all')
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
CREATE OR REPLACE FUNCTION get_home_violation_data(time_range TEXT DEFAULT 'all')
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
